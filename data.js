...
// type: "video" 或 "photo"
// video 类型: video 字段填视频文件路径, poster 填封面图路径(网格缩略图用,4:5 竖构图)
// coverVideo: 鼠标悬停(或手机上滑入屏幕)时,在网格缩略图里播放的预览片段;留空则悬停时还是显示 poster 图
// videoPoster: 详情页播放前显示的静帧,要用片子本身的画幅(横的/宽银幕的);
//              留空会退回用 poster,但那是 4:5 竖构图,横过来会被裁掉两头
// videoAspect: 详情页视频的画幅比例,填「宽/高」的小数(16:9 → 1.7778,4096×2160 → 1.8963,
//              4:3 → 1.3333,竖屏 9:16 → 0.5625)。只影响播放前的占位尺寸,
//              视频一开始加载就会用文件里的真实比例自动校正,填错也不会裁到画面
